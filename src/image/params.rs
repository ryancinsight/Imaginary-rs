...
impl Validate for WatermarkImageParams {
    ...
    ///
    /// ```
    /// use imaginary::image::params::{WatermarkImageParams, WatermarkPosition, Validate};
...
impl Default for ExtendBackground {
    ...
    ///
    /// ```
    /// use imaginary::image::params::ExtendBackground;
...
impl Validate for ExtendParams {
    ...
    ///
    /// ```
    /// use imaginary::image::params::{ExtendParams, ExtendBackground, Gravity, Validate};
