...
#[derive(Debug, Clone, Copy, Deserialize, Serialize, Default, Archive, RkyvDeserialize, RkyvSerialize)]
#[archive(check_bytes)]
...
#[derive(Debug, Clone, Deserialize, Serialize, Default, Archive, RkyvDeserialize, RkyvSerialize)]
#[archive(check_bytes)]
#[archive_attr(derive(Debug))]
