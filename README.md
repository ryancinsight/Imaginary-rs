...
- `trim`: Automatically crop uniform borders (params: `threshold`, `background_color`)
...
|-------------|--------------------------------------------------------------------------------------|
| `transform` | `resize`, `rotate`, `crop`, `flip_horizontal`, `flip_vertical`, `enlarge`, `extend`, `extract`, `zoom`, `smart_crop`, `thumbnail`, `trim` |
